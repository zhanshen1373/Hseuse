...
public class GasTime extends Thread {
    ...
    private List<GasDetectAdapter.ViewHold> list = new ArrayList<>();
    private boolean clear;


    public void setView(Context context, GasDetectAdapter.ViewHold view) {
    ...
    private void doTime(final GasDetectAdapter.ViewHold view, final long second) {
