...
public class WzlxAdapter extends BaseAdapter {
	private Context context;
	private List<Domain> data;

	public WzlxAdapter(Context context, List<Domain> data) {
		this.data = data;
	...
	public View getView(int position, View view, ViewGroup viewGroup) {
		...
		holder.dataTxt.setText(data.get(position).getDescription());
		return view;
