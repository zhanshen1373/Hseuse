 ...
 * @see 	 
 */
public class StateDownloadZYPExpandableListView2 extends
		NormalZYPExpandableListView2 {

	
	
	public StateDownloadZYPExpandableListView2(Context context,
	...
	protected BaseZYPListRow onCreateChildView() {
		...
		return new StateDownloadZYPListRow2(getContext());
	}
