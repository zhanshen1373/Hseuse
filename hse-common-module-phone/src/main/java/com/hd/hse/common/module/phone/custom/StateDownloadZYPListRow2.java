 ...
 * @see 	 
 */
public class StateDownloadZYPListRow2 extends NormalZYPListRow2 {

	public StateDownloadZYPListRow2(Context context, AttributeSet attrs,
			int defStyle) {
	...
	public StateDownloadZYPListRow2(Context context) {
		super(context);
