package com.hd.hse.dly.phone.ui.fragment.measure;
...
public class MeasureFragmentdly extends MeasureFragment {
    private WorkMeasureReview workMeasureReview;
    private static Logger logger = LogUtils.getLogger(MeasureFragmentdly.class);
    @SuppressLint("NewApi")
    @Override
    ...
    public String getIAtionType() {
        // TODO Auto-generated method stub
        return IActionType.ACTION_TYPE_DELAYPRECAUTION;
    }
    ...
    public boolean isRelation() {
        if (times == 0) {
            ...
            relationTableName.setSys_fuction(IConfigEncoding.YQ);
