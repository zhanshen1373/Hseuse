...
public class DeptListAdapter5 extends BaseAdapter {


    private Context context;
    private List<ZyxxTableName> searchData;

    public DeptListAdapter5(Context context, List<ZyxxTableName> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder2.dataTxt.setText(department.getZyname());
