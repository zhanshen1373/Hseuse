...
public class DownCBSImage extends DownFilelistener {
	...
	public Object action(String action, Object... args) throws HDException {
		...
		try {
			...
			// Object
			// obj="http://192.168.6.11:7001/maximo/upload/appcbsry/中油一建/131024199401012021.jpg";
			...
			this.setWritelog("下载承包商人员照片失败!", e);
			this.SendMessage(IMessageWhat.ERROR, 9, 9,
					e.getMessage() != null ? e.getMessage() : "下载失败,请联系管理员!");
		}
	...
	public String getSavePath() {
		return SystemProperty.getSystemProperty().getRootImagePath()
				+ File.separator + "personphoto";
	}
	...
	public Object initParam() {
		 ...
		 * hashmap.put(SYSConstant.KEYPERSONID,
		 * SystemProperty.getSystemProperty().getLoginPerson().getPersonid());
		 * //hashmap.put(SYSConstant.KEYDEPTNUM,
