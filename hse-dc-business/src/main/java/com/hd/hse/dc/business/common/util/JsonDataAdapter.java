                                    ...
                                    if (null != tb) {
                                        ...
                                        if (key2.equalsIgnoreCase("dr")
                                            ...
                                            if (!StringUtils.isEmpty(subtable)) {
                                                ...
                                                // if
                                                // (subtable.equalsIgnoreCase("ud_zyxk_zysq"))
                                                // {
                                                // // 删除主表信息
                ...
                while (iterTrPrimary.hasNext()) {
                    ...
                    while (iterTr.hasNext()) {
                        ...
                        { // 查找主表的记录主键索引的HashMap
                            ...
                            // Object attributeObj =
                            // objParent.getJSONObject(0).get(tableName);
                            //
                            // if(attributeObj!=null)
                            // {
                            // objParent.getJSONObject(0).getJSONArray(tableName).add(entryTr.getValue().get(0));
                            // }else
                            // {
