 ...
 * @see
 **/
public class HessainClientDel extends WebServiceClientDel {

	private static Logger logger = LogUtils.getLogger(HessainClientDel.class);

	private static HessianProxyFactory factory = null;
	// private static UserHessianProxyFactory factory = null;
	 ...
	 */
	public static HessainClientDel newInstance() {
		return new HessainClientDel();
	}

	private HessainClientDel() {
		// initAttribut();
	}
...
//			factory.setHessian2Reply(false);
	...
	public Object InitBaseInfo(HashMap<String, Object> map) throws HDException {
		return getRequestObject(map,
				PadInterfaceContainers.METHOD_COMMON_DOWNTABLE, null, null);
	}
	 ...
	 * TODO
	 * 
	 * @see com.hd.hse.business.webservice.WebServiceClient#DownLoadBuesinessList(HashMap,
	 *      String)
	 */
	@Override
	...
	public Object UpLoadBusiness(HashMap<String, Object> map)
			throws HDException {
		return getRequestObject(map,
				PadInterfaceContainers.METHOD_COMMON_UPTABLE, null, null);
	}
	...
	public Object UpLoadFile(String path, HashMap<String, Object> map)
		...
		try {
			...
			return getRequestObject(map,
					PadInterfaceContainers.METHOD_COMMON_UPFILE, null, data);
		} catch (Exception e) {
	...
	public Object checkUser(HashMap<String, Object> map) throws HDException {
		return getRequestObject(map,
				PadInterfaceContainers.METHOD_COMMON_CHECKUSER, null, null);
	}
	...
	public Object getVersionInfo(HashMap<String, Object> map)
			throws HDException {
		return getRequestObject(map,
				PadInterfaceContainers.METHOD_COMMON_VERSIONIFNO, null, null);
	}
	...
	public Object getPeoplePhotoUrl(HashMap<String, Object> map)
			throws HDException {
		return getRequestObject(map,
				PadInterfaceContainers.METHOD_CBS_CBSHEADIAMGEURL, null, null);
	}
