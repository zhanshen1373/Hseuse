...
/**
 * ClassName:WorkTaskSrv (现场核查作业票列表数据查询服务).<br/>
 * Date: 2014年9月28日 <br/>
 * 
 * @author lg
 * @version
...
public class WorkTaskSrv extends WorkTaskDBSrv {
	...
	protected String getWorkOrderExtWhere() throws HDException {
		...
		sbWhere.append("zysq.status in ('").append(IWorkOrderStatus.INPRG)
				.append("','").append(IWorkOrderStatus.APPAUDITED).append("') ");// 现场核查
